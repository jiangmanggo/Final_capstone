<?php
    ...
    if (isset($_SESSION['id'])) {
        ...
        $query = "SELECT farmer.`seller_id`,farmer.`fname`,`farmer`.`lname`,`farmer`.`farmers_identification_number` FROM farmer INNER JOIN association_chairman ON farmer.`association` = association_chairman.`association` WHERE association_chairman.`admin_id` = '$admin_id'";
                    ...
                    <div class="card rounded shadow border-0">
                        <div class="card-body p-2 bg-white rounded">
                            <div class="table-responsive">
                                <table id="product" style="width:100%" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>    
                                            <th>Fullname</th>
